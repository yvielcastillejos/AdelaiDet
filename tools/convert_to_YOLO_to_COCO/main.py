...
def images_annotations_info(opt):
    ...
    for line in read_lines:
        ...
        for line1 in label_read_line:
            ...
            min_x = float(label_line.split()[1])
            min_y = float(label_line.split()[2])
            width = float(label_line.split()[3])
            height = float(label_line.split()[4])
...
def debug(opt):
    ...
    for line in read_lines:
        ...
        for line1 in label_read_line:
            ...
            width = float(label_line.split()[3])   #int(img_file.shape[1]*width)
            height =  float(label_line.split()[4])  #int(img_file.shape[0]*height)
